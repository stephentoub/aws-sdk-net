...
internal sealed partial class BedrockChatClient : IChatClient
{
        ...
        IEnumerable<ChatMessage> messages, ChatOptions? options = null, CancellationToken cancellationToken = default)
    {
        ...
        request.System = CreateSystem(request.System, messages);
    ...
    private static List<SystemContentBlock> CreateSystem(List<SystemContentBlock>? rawMessages, IEnumerable<ChatMessage> messages)
    {
